...
_Draft chapter — rougher than the Core, and the data-structure specifics here are still being worked out._

The [annotations and artifact engine](04-annotations-and-engine.qmd) chapter sketches a few representative ML-pipeline operations and shows that they roughly fit the (selector, body, provenance) overlay shape. This catalogues the *features* a structural ML pipeline might want in detail, the *access patterns* into a structure file those features require.
